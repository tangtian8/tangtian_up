...
----
	@RequestMapping("/")
	public String handle(@SessionAttribute pojo.User user) { <1>
		// ...
	}
----
...
----
	@RequestMapping("/")
	fun handle(@SessionAttribute user: pojo.User): String { // <1>
		// ...
	}
----
...
----
	@GetMapping("/")
	public String handle(@RequestAttribute jdkdynamic.Client client) { // <1>
		// ...
	}
----
...
----
	@GetMapping("/")
	fun handle(@RequestAttribute client: jdkdynamic.Client): String { // <1>
		// ...
	}
----
<1> Using the `@RequestAttribute` annotation.
...
----
	...
	public class UserController {
		...
		@GetMapping("/user")
		@JsonView(pojo.User.WithoutPasswordView.class)
		public pojo.User getUser() {
			return new pojo.User("eric", "7!jd#h23");
		}
	}

	public class pojo.User {
		...
		public pojo.User(String username, String password) {
...
----
	...
	class UserController {
		...
		@GetMapping("/user")
		@JsonView(pojo.User.WithoutPasswordView::class)
		fun getUser() = pojo.User("eric", "7!jd#h23")
	}
...
----
	...
	public class UserController {
		...
		public MappingJacksonValue getUser() {
			pojo.User user = new pojo.User("eric", "7!jd#h23");
			MappingJacksonValue value = new MappingJacksonValue(user);
			value.setSerializationView(pojo.User.WithoutPasswordView.class);
			return value;
		}
	}
----
...
----
	...
	class UserController {
		...
		fun getUser(): MappingJacksonValue {
			val value = MappingJacksonValue(pojo.User("eric", "7!jd#h23"))
			value.serializationView = pojo.User.WithoutPasswordView::class.java
			return value
		}
	}
----
...
----
	...
	public class UserController extends AbstractController {
		...
		public String getUser(Model model) {
			model.addAttribute("user", new pojo.User("eric", "7!jd#h23"));
			model.addAttribute(JsonView.class.getName(), pojo.User.WithoutPasswordView.class);
			return "userView";
		}
	}
----
...
----
	...
	class UserController : AbstractController() {
		...
		fun getUser(model: Model): String {
			model["user"] = pojo.User("eric", "7!jd#h23")
			model[JsonView::class.qualifiedName] = pojo.User.WithoutPasswordView::class.java
			return "userView"
		}
	}
----
